cmd_scripts/kconfig/menu.o := gcc -Wp,-MMD,scripts/kconfig/.menu.o.d -Wall -Wmissing-prototypes -Wstrict-prototypes -O2 -fomit-frame-pointer -std=gnu89       -I ./scripts/kconfig -c -o scripts/kconfig/menu.o /home/parrot/Documents/testi/disk_image/bdss/scripts/scripts/kconfig/menu.c

source_scripts/kconfig/menu.o := /home/parrot/Documents/testi/disk_image/bdss/scripts/scripts/kconfig/menu.c
